...
public class WarehouseFirstActivity extends ToolbarActivity implements BaseFragmentPagerAdapter.Callback, ViewPager.OnPageChangeListener {
    ...
    private Map<WarehouseGoodsAdapter, AdapterDataObserver> mAdapterDataObserverHolder;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_warehouse_first_layout);
    ...
    protected void onDestroy() {
        ...
        for (Map.Entry<WarehouseGoodsAdapter, AdapterDataObserver> entry : mAdapterDataObserverHolder.entrySet()) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.add:
                ...
                WarehouseFirstAddActivity.startActivity(this, key, mLocationTextView.getText().toString());
                return true;
        }
    ...
    private void initView() {
        ...
        mSpinner = (Spinner) findViewById(R.id.warehouse_first_type);
        ...
        mRepositoryTextView = (AutoCompleteTextView) findViewById(R.id.warehouse_first_repository);
        ...
        mAreaTextView = (AutoCompleteTextView) findViewById(R.id.warehouse_first_area);
        ...
        findViewById(R.id.warehouse_first_complete).setOnLongClickListener(view -> {
            Toaster.showToast("全部完成");
            return true;
        });

        mLocationTextView = (EditText) findViewById(R.id.warehouse_first_goods_allocation);
        ...
        mGoodsTextView = (EditText) findViewById(R.id.warehouse_first_goods);
    ...
    private void obtainPdType() {
        ...
        flowable.observeOn(AndroidSchedulers.mainThread()).subscribe(new ResponseSubscriber<List<KeyValueEntity>>(this) {
            ...
            public void doNext(List<KeyValueEntity> data) {
                ...
                ArrayAdapter<KeyValueEntity> exportAdapter = new ArrayAdapter<>(WarehouseFirstActivity.this, android.R.layout.simple_spinner_item, data);
    ...
    public void onClick(View view) {
        int id = view.getId();
        switch (id) {
            case R.id.warehouse_first_complete:           //完成点击
                complete();
                break;
        }
    }
    ...
    private void obtainData() {
        ...
        Flowable<ResponseEntity<List<WarehouseGoodsEntity>>> flowable = mService.getGoodsList(entity.getKey());
        flowable.observeOn(AndroidSchedulers.mainThread()).subscribe(new ResponseSubscriber<List<WarehouseGoodsEntity>>(this) {

            @Override
            public void doNext(List<WarehouseGoodsEntity> data) {
    ...
    private Fragment createFragment(int position) {
        WarehouseInventoryFragment fragment = WarehouseInventoryFragment.newInstance(position);
        AdapterDataObserver observer = new AdapterDataObserver(fragment);
        WarehouseGoodsAdapter adapter = fragment.getAdapter();
    ...
    private class AdapterDataObserver extends RecyclerView.AdapterDataObserver {
        private WarehouseInventoryFragment mFragment;

        public AdapterDataObserver(WarehouseInventoryFragment fragment) {
            mFragment = fragment;
        }
    ...
    public void onPageSelected(int position) {
        WarehouseInventoryFragment fragment = (WarehouseInventoryFragment) getItem(position);
