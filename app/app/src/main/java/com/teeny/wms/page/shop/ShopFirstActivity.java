...
public class ShopFirstActivity extends ToolbarActivity implements BaseFragmentPagerAdapter.Callback, ViewPager.OnPageChangeListener {
    ...
    private Map<ShopGoodsAdapter, AdapterDataObserver> mAdapterDataObserverHolder;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shop_first_layout);
    ...
    protected void onDestroy() {
        ...
        for (Map.Entry<ShopGoodsAdapter, AdapterDataObserver> entry : mAdapterDataObserverHolder.entrySet()) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.add:
                ...
                ShopFirstAddActivity.startActivity(this, key, mLocationTextView.getText().toString());
                return true;
        }
    ...
    private void initView() {
        ...
        mSpinner = (Spinner) findViewById(R.id.shop_first_type);
        ...
        mRepositoryTextView = (AutoCompleteTextView) findViewById(R.id.shop_first_repository);
        ...
        mAreaTextView = (AutoCompleteTextView) findViewById(R.id.shop_first_area);
        ...
        findViewById(R.id.shop_first_complete).setOnLongClickListener(view -> {
            Toaster.showToast("全部完成");
            return true;
        });

        mLocationTextView = (EditText) findViewById(R.id.shop_first_goods_allocation);
        ...
        mGoodsTextView = (EditText) findViewById(R.id.shop_first_goods);
    ...
    private void obtainPdType() {
        ...
        flowable.observeOn(AndroidSchedulers.mainThread()).subscribe(new ResponseSubscriber<List<KeyValueEntity>>(this) {
            ...
            public void doNext(List<KeyValueEntity> data) {
                ...
                ArrayAdapter<KeyValueEntity> exportAdapter = new ArrayAdapter<>(ShopFirstActivity.this, android.R.layout.simple_spinner_item, data);
    ...
    public void onClick(View view) {
        int id = view.getId();
        switch (id) {
            case R.id.shop_first_complete:           //完成点击
                complete();
                break;
        }
    }
    ...
    private void obtainData() {
        ...
        Flowable<ResponseEntity<List<ShopGoodsEntity>>> flowable = mService.getGoodsList(entity.getKey());
        flowable.observeOn(AndroidSchedulers.mainThread()).subscribe(new ResponseSubscriber<List<ShopGoodsEntity>>(this) {

            @Override
            public void doNext(List<ShopGoodsEntity> data) {
    ...
    private Fragment createFragment(int position) {
        ShopInventoryFragment fragment = ShopInventoryFragment.newInstance(position);
        AdapterDataObserver observer = new AdapterDataObserver(fragment);
        ShopGoodsAdapter adapter = fragment.getAdapter();
    ...
    private class AdapterDataObserver extends RecyclerView.AdapterDataObserver {
        private ShopInventoryFragment mFragment;

        public AdapterDataObserver(ShopInventoryFragment fragment) {
            mFragment = fragment;
        }
    ...
    public void onPageSelected(int position) {
        ShopInventoryFragment fragment = (ShopInventoryFragment) getItem(position);
